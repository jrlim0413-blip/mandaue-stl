...
export const openIncidentReportPrint = (ticket) => {
  ...
  reportWindow.document.write(`<!doctype html><html><head><title>${escapeHtml(reportNumber)}</title><style>
    ...
    * { box-sizing: border-box; }
    ...
    .toolbar button { border: 0; border-radius: 6px; padding: 9px 15px; background: #ffd700; color: #002b66; font-weight: 800; cursor: pointer; }
    .paper { 
      ...
      background: white; 
      box-shadow: 0 4px 20px #002b6626; 
      box-sizing: border-box;
      display: flex;
      flex-direction: column;
      justify-content: space-between;
    }
    .letterhead { display: flex; align-items: center; justify-content: space-between; gap: 20px; padding-bottom: 12px; border-bottom: 1px solid #94a3b8; }
    .brand { display: flex; align-items: center; gap: 16px; }
    .brand-logo { width: 75px; height: 54px; object-fit: contain; }
    .company { color: #002b66; font-size: 16px; font-weight: 900; letter-spacing: .07em; text-transform: uppercase; }
    .company-detail { margin-top: 4px; color: #334155; font-size: 11px; line-height: 1.4; }
    .stl-logo { width: 75px; height: 54px; object-fit: contain; }
    .classification { align-self: start; padding: 6px 11px; border: 2px solid #002b66; color: #002b66; font-size: 9.5px; font-weight: 800; letter-spacing: .1em; text-align: center; text-transform: uppercase; }
    .heading { display: flex; justify-content: space-between; align-items: flex-end; gap: 16px; padding: 14px 0 12px; border-bottom: 3px solid #002b66; }
    .eyebrow { margin: 0 0 5px; color: #64748b; font-size: 10.5px; font-weight: 700; letter-spacing: .15em; text-transform: uppercase; }
